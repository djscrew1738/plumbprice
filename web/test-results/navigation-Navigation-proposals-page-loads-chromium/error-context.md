...
- Name: navigation.spec.ts >> Navigation >> proposals page loads
- Location: tests/e2e/navigation.spec.ts:28:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/proposals
Call log:
  - navigating to "http://localhost:3000/proposals", waiting until "load"
