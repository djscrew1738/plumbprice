...
- Name: navigation.spec.ts >> Navigation >> blueprints page loads
- Location: tests/e2e/navigation.spec.ts:10:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/blueprints
Call log:
  - navigating to "http://localhost:3000/blueprints", waiting until "load"
