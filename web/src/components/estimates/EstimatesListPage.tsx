                    ...
                    <div className="flex items-start justify-between gap-2 mb-3">
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-1.5 flex-wrap">
                          ...
                          <span className={cn('badge', STATUS_CLASS[est.status] ?? 'bg-white/[0.04] text-zinc-500 border border-white/[0.08]')}>{est.status}</span>
                  ...
                  <AnimatePresence initial={false}>
                    {visible.map((est, i) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3"><span className={cn('badge', STATUS_CLASS[est.status] ?? 'bg-white/[0.04] text-zinc-500 border border-white/[0.08]')}>{est.status}</span></td>
