...
This is a convenience script for admin use and mirrors the admin import endpoint.
"""
import asyncio
import sys
import os
...
# Ensure the api package is importable when the script runs from /app/api/scripts
